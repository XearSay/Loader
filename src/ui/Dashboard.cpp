...
void DrawSideLinks(Theme& theme, UiState& ui, float contentAlpha, float dt, bool modalOpen,
    ...
    LinkBtn links[3] = {
        {"Website", 50.f, &ui.siteHover, L"https://ru.neverlose.cc/"},
        {"Support", 70.f, &ui.discordHover, L"https://forum.neverlose.cc/top?period=monthly"},
        {"Market", 80.f, &ui.telegramHover,
         L"https://github.com/s0daa/CSGO-HVH-LUAS/tree/main/Neverlose"},
    };
    float buttonY = 100.f;
    for (auto& btn : links) {
